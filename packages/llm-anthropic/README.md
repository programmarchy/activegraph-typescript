...
```bash
npm install @activegraph/llm-anthropic @anthropic-ai/sdk
```

> Requires the following peer dependency, which you install yourself so you control the version: `@anthropic-ai/sdk`.
